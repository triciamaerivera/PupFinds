...
public class ReturnedItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.returned_items_activity);
        ...
        bottomNavigationView.setSelectedItemId(R.id.bottom_returned);
